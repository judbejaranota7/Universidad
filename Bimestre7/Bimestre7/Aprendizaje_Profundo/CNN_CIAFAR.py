...
# Hyper-ParÃ¡metros 
batch_size = 64
weight_decay = 0.0001   # Factor para la regularizaciÃ³n L2
learning_rate = 0.0001
use_data_augmentation = True

# AcÃ¡ hay que descomentar la red que se quiera usar
net = MLP()
# net = SimpleCNN()
...
net.to(device)
# Elegimos la funciÃ³n de pÃ©rdida y el optimizador.
...
for epoch in range(1000): 
    ...
    if (current_epoch % 10) == 0:
        # Mostramos estadÃ­sticas del aprendizaje (incluyendo rendimiento en train y test)
        ...
        # Nomalizo las funciones de pÃ©rdida para que sean comparables entre train y test
        # Ocurre que el set de train es 5 veces mÃ¡s grande que el set de test... por eso las multiplico por 5
